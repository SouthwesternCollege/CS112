...
public class Pokemon {
    ...
    public Pokemon(String name, String type1, String type2) throws IllegalArgumentException{
        if(!this.setAll(name, type1, type2)) {
            System.err.println("ERROR: Pokemon full constructor illegal argument passed. Exiting program.");
    ...
    public Pokemon(Pokemon p) throws IllegalArgumentException {
        if(p == null) {
            System.err.println("ERROR: Pokemon copy constructor illegal argument (null) passed.");
            throw new IllegalArgumentException();
        }
